<template>
  <el-dialog class="reportTypeEditWrap" center title="编辑" v-if="value" :visible="value" width="450px" @close="beforeClose"  :close-on-click-modal="false">
    <el-form :model="formData" :rules="formRules" label-width="56px" class="v-form" @submit.native.prevent>
      <el-form-item label="名称" prop="image">
        <el-input v-model="formData.name" size="small" :maxlength="50" placeholder="请填写报表类型名称"> </el-input>
      </el-form-item>
